...
export const creditBenefits = [
  "Each consultation requires <strong class='text-[#6ba49f]'>2 credits</strong> regardless of duration",
  "Credits <strong class='text-[#6ba49f]'>never expire</strong> - use them whenever you need",
  "Monthly subscriptions give you <strong class='text-[#6ba49f]'>fresh credits every month</strong>",
  "Cancel or change your subscription <strong class='text-[#6ba49f]'>anytime</strong> without penalties",
];
