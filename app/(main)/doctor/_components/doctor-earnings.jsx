          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-client">
                  {availableCredits}
                </p>
              ...
              <div className=" bg-emerald-900/10 p-3 rounded-full">
                <Coins className="h-6 w-6 text-client" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-emerald-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-emerald-900/10 p-3 rounded-full">
                <TrendingUp className="h-6 w-6 text-client" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-emerald-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-emerald-900/10 p-3 rounded-full">
                <Calendar className="h-6 w-6 text-client" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-emerald-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-emerald-900/10 p-3 rounded-full">
                <BarChart3 className="h-6 w-6 text-client" />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border-emerald-900/20">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-client flex items-center">
            <CreditCard className="h-5 w-5 mr-2 text-client" />
            Payout Management
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-medium text-client">
                Available for Payout
              </h3>
              {pendingPayout ? (
                <Badge
                  variant="outline"
                  className=" border-amber-900/30 text-amber-700"
                >
                  PROCESSING
                </Badge>
              ) : (
                <Badge
                  variant="outline"
                  className=" border-emerald-900/30 text-client"
                >
                  Available
                </Badge>
              )}
            ...
            {pendingPayout ? (
              <div className="space-y-2">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div>
                    ...
                    <p className="text-client font-medium">
                  ...
                  <div>
                    <p className="text-muted-foreground">UPI / Bank Transfer</p>
                    <p className="text-client font-medium text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-client font-medium">{availableCredits}</p>
                </div>
                <div>
            ...
            {!pendingPayout && availableCredits > 0 && (
              <Button
                ...
                className="w-full mt-4 bg-client hover:bg-client/90"
              >
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              ...
              credits and are processed via UPI /Bank.
            </AlertDescription>
          </Alert>
      ...
      <Dialog open={showPayoutDialog} onOpenChange={setShowPayoutDialog}>
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="paypalEmail">UPI /Bank </Label>
              <Input
                id="paypalEmail"
                type="email"
              ...
              />
              <p className="text-sm text-muted-foreground">
                Enter the UPI/Bank where you want to receive the payout.
              </p>
            </div>
