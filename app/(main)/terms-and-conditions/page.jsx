...
export const metadata = {
  title: "Terms & Conditions - MediCloud",
  description: "Terms and conditions for using the MediCloud SaaS platform.",
};
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <p>
          MediCloud is a SaaS-based technology platform that provides appointment booking
          and practice management software tools.
        </p>

        <p>
          MediCloud does not provide medical consultation, diagnosis, treatment, or
        ...
        <p>
          ...
          MediCloud is not responsible for the outcome, quality, or nature of sessions
        ...
        <div className="bg-muted/40 p-6 rounded-lg border border-border/50 mt-8">
          ...
          <p className="text-sm">
            MediCloud is a technology platform and does not provide medical consultation,
